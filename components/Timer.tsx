  ...
  return (
    <div className="w-full space-y-2">
      ...
      <div
        ...
        } border font-orbitron ${Boolean(counter <= 60) ? (side === "white" ? "animate-textBlack" : "animate-textWhite") : ""}`}
      >
        {convertTwoDigit(Math.floor(counter / 60))}:{convertTwoDigit(Math.floor(counter % 60))}
      </div>
